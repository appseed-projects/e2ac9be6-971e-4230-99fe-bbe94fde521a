...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-05 12:16`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e2ac9be6-971e-4230-99fe-bbe94fde521a.git
$ cd e2ac9be6-971e-4230-99fe-bbe94fde521a
```
